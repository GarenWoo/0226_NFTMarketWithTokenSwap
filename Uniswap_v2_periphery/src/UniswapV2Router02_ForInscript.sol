...
import '../lib/Uniswap_v2_core/src/interfaces/IUniswapV2Factory.sol';
import '../lib/Uniswap_solidity_lib/contracts/libraries/TransferHelper.sol';
import {UniswapV2Pair} from '../lib/Uniswap_v2_core/src/UniswapV2Pair.sol';
...
contract UniswapV2Router02_ForInscript is IUniswapV2Router02 {
    using SafeMath for uint;

    address public immutable factory;
    address public immutable WETH;

    error FunctionBanned();
    ...
    // Note This function is Banned in this DEX router which is customized for inscription.
